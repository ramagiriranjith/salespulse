...
exports.addMenuItem = async (req, res) => {
    try {
        ...
        const {title, price, netPrice, taxId, discount, categoryId, inventoryId} = req.body;
        ...
        const menuItemId = await addMenuItemDB(title, price, netPrice, taxId, discount, categoryId, tenantId, inventoryId);
...
exports.updateMenuItem = async (req, res) => {
    try {
        ...
        await updateMenuItemDB(id, title, price, netPrice, taxId, discount, categoryId, tenantId, inventoryId);
