...
exports.addStoreTable = async (req, res) => {
    try {
        ...
        const id = await addStoreTableDB(title, floor, seatingCapacity, occupancyStatus, tenantId);
        return res.status(200).json({
            success: true,
...
exports.updateStoreTable = async (req, res) => {
    try {
        ...
        await updateStoreTableDB(id, title, floor, seatingCapacity, occupancyStatus, tenantId);
        return res.status(200).json({
            success: true,
