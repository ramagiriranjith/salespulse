...
export default function SubscriptionDetails() {
  ...
  return (
    <div className="w-full md:w-96 rounded-3xl border border-salespos-green-light px-4 py-3">
      <div className="flex items-center gap-2">
        <div className="w-10 h-10 flex items-center justify-center rounded-2xl bg-salespos-green text-white">
