              ...
              <div className="flex-1">
                <div className="flex items-center flex-col text-center gap-2">
                  ...
                  <div>
                    ...
                    {designation && <p className="text-xs text-white bg-salespos-green rounded-full w-fit px-2 mx-auto mt-1">{designation}</p>}
                  </div>
        ...
        <div className="modal-box">
          ...
          <div className="mt-4">
              ...
              <input
                ...
                type="email"
                name="username"
                className=" cursor-not-allowed disabled:bg-gray-200 text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-salespos-border-green-light"
