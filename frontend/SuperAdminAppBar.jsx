...
export default function SuperAdminAppBar() {
  ...
  return (
    <div className="flex items-center justify-between px-4 py-3 border-b border-salespos-border-green-light w-full bg-white/90 backdrop-blur sticky top-0 z-[9999]">
      <div></div>

      {/* profile */}
      <Menu as="div" className="relative inline-block text-left z-50">
        <div>
          <Menu.Button className="text-sm bg-salespos-green-light hover:bg-salespos-green/30 transition text-salespos-green-dark  rounded-full flex items-center gap-0 md:gap-2">
            <img
              src={AvatarImg}
              alt="avatar"
              ...
              <Menu.Item>
                {({ active }) => (
                  <Link
                    ...
                    className={`${
                      active
                        ? "bg-salespos-green-light text-salespos-green-dark"
                        : "text-salespos-green-dark"
