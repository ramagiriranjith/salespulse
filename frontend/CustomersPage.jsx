    ...
    <Page>
      <div className="flex flex-wrap gap-4 flex-col md:flex-row items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <button onClick={btnSearch} className="text-white bg-salespos-green transition hover:bg-salespos-green/80 active:scale-95 rounded-lg px-4 py-1 outline-salespos-border-green-light">
            Search
          </button>
        </div>
      </div>
...

      {
        customers?.length > 0 && <div className="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-4">
        {
          customers.map((customer, index)=>{
            ...
            return (<div key={phone} className="border border-salespos-border-green-light rounded-2xl px-4 py-5">
      ...
      <div className="modal-box">
        ...
        <div className="mt-4">
          ...
          <input
            ...
            name="phone"
            disabled
            className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 disabled:text-gray-400 outline-salespos-border-green-light cursor-not-allowed"
