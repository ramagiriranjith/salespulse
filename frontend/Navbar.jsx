...
export default function Navbar() {
  ...
  if (isNavbarCollapsed) {
    return (
      <div className="flex flex-col items-start gap-3 bg-salespos-green-light h-screen px-5 py-6 overflow-y-auto fixed left-0 top-0">
        ...
        {navbarItems.filter((navItem)=>{
          ...
          return (
            <Link
              key={index}
              className={clsx(
                "w-12 h-12 flex items-center justify-center rounded-full transition hover:bg-salespos-border-green-light text-salespos-green-dark",
                {
                  "bg-salespos-border-green-light font-medium": pathname.includes(
                    item.path
                  ),
                }
              )}
        ...
        <button
          ...
          className="w-12 h-12 flex items-center justify-center rounded-full transition hover:bg-salespos-border-green-light text-salespos-green-dark"
        >
  ...
  return (
    <div className="relative h-screen">
      <div className="md:w-72 flex flex-col items-start gap-2 md:gap-3 bg-salespos-green-light h-screen px-5 py-6 overflow-y-auto fixed left-0 top-0">
        ...
        {navbarItems.filter((navItem)=>{
          ...
          return (
            <Link
              key={index}
              className={clsx(
                "w-12 h-12 md:w-full flex justify-center md:justify-normal items-center md:gap-1 md:px-4 md:py-3 rounded-full transition hover:bg-salespos-border-green-light text-salespos-green-dark",
                {
