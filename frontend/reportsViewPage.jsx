...
export default function ReportsViewPage() {
    ...
    const {
        ordersCount, newCustomers, repeatedCustomers, currency: currencyCode, averageOrderValue, totalCustomers, netRevenue, taxTotal, topSellingItems, revenueTotal, totalPaymentsByPaymentTypes
    } = data;
    ...
    return (
        <Page>
            ...
            <div className="grid   grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
                {/* popular items */}
                <div className='row-span-3 border border-salespos-border-green-light rounded-3xl h-96 overflow-y-auto'>
                ...
                <div className="border border-salespos-border-green-light rounded-3xl  py-5 px-6 row-span-3">
                    <h3 className="font-bold">Payments By Methods</h3>
