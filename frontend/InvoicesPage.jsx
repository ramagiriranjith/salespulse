              ...
              {state.searchResults.map((invoice, index)=>{
                ...
                return <tr key={index}>
                  ...
                  <td className="flex items-center gap-2">
                    <button onClick={()=>{btnViewReceipt(orderIdsArr, tokens, payment_type_id)}} className="btn btn-sm btn-circle text-slate-500">
                      <IconReceipt stroke={iconStroke} />
                    </button>
                    <button onClick={()=>{btnPrintReceipt(orderIdsArr, tokens, payment_type_id)}} className="btn btn-sm btn-circle text-slate-500">
