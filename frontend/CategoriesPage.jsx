      ...
      <dialog id="modal-add" className="modal modal-bottom sm:modal-middle">
        <div className="modal-box">
          ...
          <div className="my-4">
            ...
            <input ref={categoryTitleRef} type="text" name="title" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-salespos-border-green-light" placeholder="Enter Category Title..." />
          </div>
      ...
      <dialog id="modal-update" className="modal modal-bottom sm:modal-middle">
        <div className="modal-box">
          ...
          <div className="my-4">
            ...
            <label htmlFor="title" className="mb-1 block text-gray-500 text-sm">Category Title</label>
            <input ref={categoryTitleUpdateRef} type="text" name="title" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-salespos-border-green-light" placeholder="Enter Category Title..." />
          </div>
