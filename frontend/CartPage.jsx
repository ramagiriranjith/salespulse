      ...
      <div className="h-28"/>
        ...
        {cartItems.length > 0 && (
          <div className="fixed bottom-0 left-0 right-0 bg-white shadow-lg p-4 flex justify-between items-center rounded-2xl md:w-96 mx-auto">
            ...
            className="bg-salespos-green text-white py-4 px-6 rounded-xl flex justify-between w-full items-center">
        ...
        <div className="modal-box">
            ...
            <div className="flex flex-col justify-around mt-4">
              <button
                className={`rounded-lg transition px-4 py-3 text-lg font-semibold  border-2 ${
                  !showPhoneFields ? 'bg-white border-salespos-green text-salespos-green shadow-sm' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                }`}
          ...
          <div className="modal-action justify-center w-full">
            <button
              ...
              className="rounded-lg hover:bg-salespos-green-dark transition active:scale-95 hover:shadow-lg px-4 py-4 bg-salespos-green text-white w-full text-xl font-semibold"
            >
              Place Order
            </button>
          </div>
