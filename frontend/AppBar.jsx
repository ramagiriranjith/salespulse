...
export default function AppBar() {
  ...
  const searchItems = [
    ...
    },
    {
        ...
        description: "",
        icon: <IconBook stroke={iconStroke} />,
        link: "/dashboard/settings/inventory-items",
        scopes: [SCOPES.SETTINGS]
    },
    {
      title: "Tax Setup",
  ...
  return (
    <>
      <div className="flex items-center justify-between px-4 py-3 border-b border-salespos-border-green-light w-full bg-white sticky top-0 backdrop-blur-md z-[9999]">
        {/* search */}
        <button
          onClick={btnShowSearchModal}
          className="bg-salespos-green-light text-gray-400  rounded-full flex items-center px-3 py-2 gap-2"
        >
