...
import { getItemSaleReport } from '../../controllers/reports.controller';
import {jsPDF} from "jspdf";
import html2canvas from "html2canvas-pro";
import toast from 'react-hot-toast';


export const ItemSaleReport = () => {
  ...
  const getReport = async () => {
    ...
    setReportData([]);
    const data = await getItemSaleReport(startDate, endDate);
    setReportData(data);
  }
  ...
  return (
    <Page>
      <h3 className="text-2xl"> Item Sale Report</h3>
