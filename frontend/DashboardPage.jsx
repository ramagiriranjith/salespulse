  ...
  return (
    <Page>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
       ...
       {/* */}{/* reservation */}{/*
        <div className='border border-salespos-border-green-light rounded-3xl h-96 overflow-y-auto'>
        ...
        */}{/* popular items */}{/*
        ...
        <div className="flex flex-col gap-6">
          */}{/* items sold */}{/*
        <div className='border border-salespos-border-green-light rounded-3xl h-28 py-5 px-6'>
        ...
        */}{/* banner: view more in reports */}{/*
        <Link to="/dashboard/reports" className='block rounded-3xl py-5 px-6 hover:bg-gray-50 transition active:scale-95 border border-salespos-border-green-light text-salespos-green-dark bg-[url(/assets/circle_illustration.svg)] bg-no-repeat bg-right-bottom'>
          <p>View More Data in Reports <IconChevronRight stroke={iconStroke}/></p>
        </Link>
        */}{/* banner: view more in reports */}
              {/*<iframe title="TotalOrdersByCustomers" width="1000" height="600" src="https://app.powerbi.com/view?r=eyJrIjoiMzc3YTg4NzEtMzlhMi00MDZjLTkyNzgtMjJkOWRjZjFkNGVmIiwidCI6IjU4MTQwZmRkLTBiYzUtNGE3Mi1hYjk4LTk2YjRmMzZkYjgzYiJ9" frameborder="0" allowFullScreen="true"></iframe>*/}
        <iframe title="LatestOrdersByCustomers" width="1200" height="1000" src="https://app.powerbi.com/view?r=eyJrIjoiOTVhMWI1NzItOTIwYi00MTY3LWFmMjItNGY2ZDAxYmQzY2QwIiwidCI6IjU4MTQwZmRkLTBiYzUtNGE3Mi1hYjk4LTk2YjRmMzZkYjgzYiJ9" frameborder="0" allowFullScreen="true"></iframe>
      </div>
