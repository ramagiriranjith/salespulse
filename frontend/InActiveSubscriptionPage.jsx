...
export default function InActiveSubscriptionPage() {
  ...
  return (
    <Page className="">
      <div className="flex items-center justify-between px-4 py-3 border-b border-salespos-border-green-light w-full bg-white">
      ...
      >
        <div className="rounded-2xl px-8 py-6 border flex flex-col w-full lg:w-96">
          ...
          <button onClick={btnSubscribe} className="rounded-full bg-salespos-green text-white px-4 py-3 transition active:scale-95 hover:bg-salespos-green-dark mt-6">Subscribe</button>
        </div>
      </div>
        </>:<div>
