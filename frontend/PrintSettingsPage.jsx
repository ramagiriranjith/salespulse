      ...
      <div className="mt-8 text-gray-500 text-sm">
        ...
        <div className="mt-4 w-full lg:min-w-96">
          ...
          <select
            ...
            name="pageSize"
            id="pageSize"
            className="block w-full border rounded-lg px-4 py-2 bg-gray-50 text-gray-500 outline-salespos-border-green-light"
          >
            <option hidden value="">
              Select Page Size
            </option>
        ...
        <button
          onClick={btnSave}
          className="text-white w-full lg:min-w-96 bg-salespos-green transition hover:bg-salespos-green/80 active:scale-95 rounded-lg px-4 py-2 mt-6 outline-salespos-border-green-light"
        >
          Save
        </button>
      </div>
