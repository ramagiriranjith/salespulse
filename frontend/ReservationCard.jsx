...
export default function ReservationCard({
  ...
  return (
    <div
      key={unique_code}
      className="text-salespos-green-dark border border-salespos-border-green-light rounded-2xl p-4 flex gap-4 items-center"
    >
      ...
      <div className="flex-1">
        ...
        <div className="flex items-center gap-4 text-sm text-salespos-green-dark">
