...
import { getSupplierDueReport } from '../../controllers/reports.controller';
...
export const SupplierDueReport = () => {
  ...
  const getReport = async () => {
    ...
    setReportData([]);
    const data = await getSupplierDueReport(startDate, endDate);
    setReportData(data);
  }
  ...
  return (
    <Page>
      <h3 className="text-2xl"> Supplier Due Report</h3>
