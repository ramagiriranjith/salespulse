            ...
            <div className="flex-1">
              ...
              >
                ...
                {storeTables.map((storeTable) => (
                  ...
                  disabled={storeTable.occupancy_status === 'occupied'}
      className={storeTable.occupancy_status === 'occupied' ? 'opacity-50 cursor-not-allowed' : ''}
                  >
        ...
        <div className="modal-box">
          ...
          <div className="flex gap-4 w-full my-4">
            ...
            <div className="flex-1">
              ...
              >
                <option value="">Select Table</option>
                {storeTables.filter((storeTable) => storeTable.occupancy_status === 'vacant').map((storeTable, index) => (
                  <option key={storeTable.id} value={storeTable.id}>
                    {storeTable.table_title} (Capacity:{" "}
                    {storeTable.seating_capacity}) - {storeTable.floor}
                  </option>
