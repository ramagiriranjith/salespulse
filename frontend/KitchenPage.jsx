...

      {
...

        {
          kitchenOrders.map((order, index)=>{
            ...
            return <div key={index} className="border border-salespos-border-green-light rounded-2xl px-4 py-5 flex flex-col">
              ...
              <div className="mt-4 flex flex-col divide-y">
                {
                  ...
                  .map((item, index)=>{
                    ...
                    return  <div key={index} className="flex items-center gap-2 py-2">
                      ...
                      {status == "completed" && <IconCheck stroke={iconStroke} className="text-red-500" />}
                      {status == "cancelled" && <IconX stroke={iconStroke} className="text-red-500" />}
                      {status == "delivered" && <IconChecks stroke={iconStroke} className="text-red-500" />}
                      {/* status */}
